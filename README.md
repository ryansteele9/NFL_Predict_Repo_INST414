...
```bash
python -m my_project3.data.download_team_stats
python -m my_project3.data.download_odds
```
...
```bash
python -m my_project3.data.feature_engineering_team
```
Build full matchup dataset across all seasons (2022-2025):
```bash
python -m my_project3.data.build_full_matchup_data
```
Train XGBoost Model:
```bash
python -m my_project3.modeling.train
```
